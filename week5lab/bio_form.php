...
<?php
  ...
  array("name"=>"Universiti Islam Antarabangsa Malaysia","abb"=>"UIAM"),
  array("name"=>"Universiti Utara Malaysia","abb"=>"UUM"),
  array("name"=>"Universiti Malaysia Sarawak","abb"=>"UNIMAS"),
  ...
  array("name"=>"Universiti Teknikal Malaysia Melaka","abb"=>"UTeM"),
...
<hr>
<input type="hidden" name="matricnum" value="a174863">
