  ...
  <div class="row">
    ...
    <table class="table table-bordered">
      ...
      try {
        ...
        $sql = $sql."tbl_orders_a174863.fld_customer_num = tbl_customers_a174863_pt2.FLD_CUSTOMER_ID ORDER BY tbl_orders_a174863.fld_order_date DESC LIMIT {$start_from}, {$per_page}";
    ...
    <nav>
      <ul class="pagination">
        ...
        try {
          ...
          $sql = "SELECT * FROM tbl_orders_a174863, tbl_staffs_a174863_pt2, tbl_customers_a174863_pt2 WHERE ";
          $sql = $sql."tbl_orders_a174863.fld_staff_num = tbl_staffs_a174863_pt2.FLD_STAFF_ID and ";
          $sql = $sql."tbl_orders_a174863.fld_customer_num = tbl_customers_a174863_pt2.FLD_CUSTOMER_ID LIMIT {$start_from}, {$per_page}";
          $stmt = $conn->prepare($sql);
          $stmt->execute();
          $result = $stmt->fetchAll();
