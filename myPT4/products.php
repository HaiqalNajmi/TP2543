        ...
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            <div class="col-md-8">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="type" class="form-control" id="producttype" required>
                    <option value="">Please select</option>
                    <option value="PetFish" <?php if(isset($_GET['edit'])) if($editrow['FLD_TYPE']=="PetFish") echo "selected"; ?>>PetFish</option>
                    <option value="FishFood" <?php if(isset($_GET['edit'])) if($editrow['FLD_TYPE']=="FishFood") echo "selected"; ?>>FishFood</option>
                    <option value="AquariumSupplies" <?php if(isset($_GET['edit'])) if($editrow['FLD_TYPE']=="AquariumSupplies") echo "selected"; ?>>AquariumSupplies</option>
                  </select><br>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input name="quantity" type="number" class="form-control" id="productqty" placeholder="Product Quantity" value="<?php if(isset($_GET['edit'])) echo $editrow['FLD_QUANTITY']; ?>" min="0" max="999" step="1" required>
                </div>
              </div>
            ...
            <div class="col-md-4" style="height: 100%">
              <div class="thumbnail dark-1">
                ...
                alt="Product Image" style="width: 60%;height: 225px;">
