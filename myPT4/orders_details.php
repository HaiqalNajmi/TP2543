...
<head>
  ...
  <title>Pet Fish Ordering System : Order Details</title>
  <!-- Bootstrap -->
  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    <?php
      try {
        ...
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a174863, tbl_staffs_a174863_pt2,
          tbl_customers_a174863_pt2 WHERE
    ...
    <div class="container-fluid dark" style="padding-bottom: 30px; padding-top: 30px;">
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
          <div class="panel dark-1">
            <div class="panel-heading"><strong>Order Details</strong></div>
              ...
              <table class="table order-detail" style="border-color: #FFFFFF;">
                <tr>
                ...
                <div class="col-sm-9">
                  <select name="pid" class="form-control" id="prd">
                    ...
                    foreach($result as $productrow) {
                      ?>
                      <option value="<?php echo $productrow['FLD_PRODUCT_ID']; ?>"><?php echo $productrow['FLD_SIZE']." ".$productrow['FLD_PRODUCT_NAME']; ?></option>
                    <?php
                      }
                      $conn = null;
                    ?>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
            ...
            <table class="table table-bordered">
              <tr style="background: #003566; color: #ffffff;">
